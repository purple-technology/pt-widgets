import { r as registerInstance, h, g as getElement } from './core-6e273e08.js';
...
var dist = createCommonjsModule(function (module, exports) {
    ...
    function _defaults(obj, defaults) { var keys = Object.getOwnPropertyNames(defaults); for (var i = 0; i < keys.length; i++) {
        var key = keys[i];
...
var Debounce$1 = unwrapExports(dist);
...
var sparkline = function (t) {
    ...
    return r.m = t, r.c = e, r.d = function (t, e, n) { r.o(t, e) || Object.defineProperty(t, e, { enumerable: !0, get: n }); }, r.r = function (t) { "undefined" != typeof Symbol && Symbol.toStringTag && Object.defineProperty(t, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(t, "__esModule", { value: !0 }); }, r.t = function (t, e) {
        ...
        if (r.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: t }), 2 & e && "string" != typeof t)
            for (var o in t)
                r.d(n, o, function (e) { return t[e]; }.bind(null, o));
        return n;
...
}([function (t, _, r) { var n = r(2), o = r(3), i = r(4); t.exports = function (t) { return n(t) || o(t) || i(); }; }, function (_, e, r) {
        ...
        function c(t, e, r) {
            var n;
            if (n = t, o()(n.querySelectorAll("*")).forEach(function (t) { return n.removeChild(t); }), !(e.length <= 1)) {
    ...
    }, function (t, _) { t.exports = function () { throw new TypeError("Invalid attempt to spread non-iterable instance"); }; }]); // tslint:disable-line
...
var Widget = /** @class */ (function () {
    ...
    class_1.prototype.validateName = function (newValue) {
    ...
    class_1.prototype.calculateSize = function () {
        var w = this.el.querySelector('.sparkline--container');
    ...
    class_1.prototype.getData = function () {
        ...
        axios$1({
            ...
            _this_1.name = response.data.name;
            _this_1.currency = response.data.currency;
            _this_1.gain = response.data.gainsSum;
            _this_1.data = response.data.dailyGains;
            _this_1.generateChart();
        });
    };
    class_1.prototype.generateChart = function () {
        var comp = this;
        var options = {
            width: this.width,
            //height: this.height,
            ...
            onmousemove: function (event, datapoint) {
                ...
                var pos = comp.data.map(function (i) { return i.date; }).indexOf(datapoint.date);
                var firstHalf = pos < comp.data.length / 2;
        ...
        var svgEl = this.el.querySelector('.sparkline');
        svgEl.innerHTML = '';
        console.log(svgEl);
    ...
    class_1.prototype.render = function () {
        console.info('render');
        var className = dedupe('pt-widget', {
            'my-class': true,
        });
        return h("div", { class: className }, h("h3", { class: "widget--header" }, this.name), h("div", { class: "widget--gain" }, this.gain, " %"), h("div", { class: "widget--currency" }, this.currency.map(function (c) { return h("div", null, c); })), h("div", { class: "sparkline--container" }, h("svg", { class: "sparkline", width: this.width, height: this.height, "stroke-width": "2", stroke: "blue", fill: "transparent" }), h("span", { class: "sparkline--tooltip" })));
    };
